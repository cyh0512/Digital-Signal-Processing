...
%y=amp*sin(2*pi*f0*t);
%y=amp*cos(2*pi*f0*t);
y=amp*cos(2*pi*f0*t)+1.5*sin(2*pi*4*t);
%y=amp*cos(2*pi*f0*t-0.2*pi)+cos(2*pi*30*t)+2*sin(2*pi*4*t);
%y=amp*cos(2*pi*f0*t-0.2*pi)+cos(2*pi*8*t)+1.5*sin(2*pi*125*t);
%y=amp*cos(2*pi*f0*t-0.2*pi)+cos(2*pi*8*t)+1.5*sin(2*pi*125*t);
%y=amp*cos(2*pi*f0*atan(0t-0.2*pi);
...
f0=70;
amp=2.7;
y=sin(2*pi*15*t) + amp*sin(2*pi*f0*t);
%y=amp*sin(2*pi*f0*t);
figure
subplot(311);plot(t,y);title(['f= ' num2str(f0) '  amp. of sinusoidal=  '  num2str(amp)]);
% plot half of samplng freuency
